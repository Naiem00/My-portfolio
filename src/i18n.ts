...
const resources = {
  ...
  ja: {
    translation: {
      ...
      heroSub1: "クラウドインフラを志向するジュニアITエンジニア。",
      ...
      aboutLabel: "自己紹介",
      aboutBio: "富山県高岡市を拠点とするジュニアITエンジニアです。AWSとクラウドインフラを中心に学んでおり、2026年3月に駿台電子情報ビジネス専門学校 ITエキスパートコースを卒業しました。AWS、Linux、ネットワーク、データベース、ソフトウェア開発の技術基盤を持ち、信頼性と拡張性の高いクラウドソリューションの構築に関心があります。",
